...
[`babel/register`]({{ site.baseurl }}/docs/usage/register),
[`babel-node`]({{ site.baseurl }}/docs/usage/cli#babel-node) as well as across the entire range
...
See the [docs]({{ site.baseurl }}/docs/usage/babelrc) for more info.
...
[docs]({{ site.baseurl }}/docs/usage/plugins) for more info.
