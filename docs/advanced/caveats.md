...
Babel feature requirements by using the included [polyfill]({{ site.baseurl }}/docs/usage/polyfill).
...
[Babel polyfill]({{ site.baseurl }}/docs/usage/polyfill) will add support for these methods.
...
[protoToAssign]({{ site.baseurl }}/docs/advanced/transformers/spec/proto-to-assign) for a possible work
around.

For classes that have `super`s, the super class won't resolve correctly. You can
get around this by enabling [loose mode]({{ site.baseurl }}/docs/advanced/loose/) for classes.
...
[loose mode - modules]({{ site.baseurl }}/docs/advanced/loose/#es6-modules).
