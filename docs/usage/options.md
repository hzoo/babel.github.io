...
| `loose`                  | `[]`                 | Array of transformers to enable [loose mode]({{ site.baseurl }}/docs/advanced/loose) on. |
| `optional`               | `[]`                 | Array of transformers to [optionally]({{ site.baseurl }}/docs/advanced/transformers#optional) use. Run `babel --help` to see a full list of transformers. Optional transformers displayed inside square brackets. |
...
| `externalHelpers`        | `false`              | Uses a reference to `babelHelpers` instead of placing helpers at the top of your code. Meant to be used in conjunction with [external helpers]({{ site.baseurl }}/docs/advanced/external-helpers). |
| `code`                   | `true`               | Enable code generation |
| `ast`                    | `true`               | Include the AST in the returned object |
| `stage`                  | `2`                  | Set the [experimental]({{ site.baseurl }}/docs/usage/experimental) proposal stage. |
...
| `metadataUsedHelpers`    | `false`              | See [external helpers - selective builds]({{ site.baseurl }}/docs/advanced/external-helpers#selective-builds) for more information. |
...
| `babelrc`                | `null`               | Specify a custom file path to load a `.babelrc` config from. |
